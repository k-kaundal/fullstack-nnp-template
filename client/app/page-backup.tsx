      ...
      <section className="py-24 sm:py-32 bg-gray-50 dark:bg-gray-900/50">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-6 sm:grid-cols-2 lg:max-w-none lg:grid-cols-4">
            ...
            {/* Blog CMS */}
            <div className="group relative bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 hover:shadow-xl hover:ring-2 hover:ring-emerald-500 dark:hover:ring-emerald-400 transition-all duration-300">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-600 dark:bg-emerald-500 mb-4 group-hover:scale-110 transition-transform">
                <svg
                  className="h-6 w-6 text-white"
                  fill="none"
                  stroke="currentColor"
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Blog CMS</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                Full-featured blog with TipTap WYSIWYG editor, categories, tags, SEO metadata, and
                draft management
              </p>
            </div>
      ...
      <section className="py-16 bg-white dark:bg-gray-900 border-y border-gray-200 dark:border-gray-800">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            ...
            <div className="text-center">
              <p className="text-4xl font-bold text-gray-900 dark:text-white">13+</p>
